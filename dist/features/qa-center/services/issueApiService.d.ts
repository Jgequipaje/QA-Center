...
export declare function createIssue(baseUrl: string, issue: Omit<Issue, "id" | "createdAt" | "updatedAt">): Promise<Issue>;
export declare function patchIssue(baseUrl: string, id: string, patch: Partial<Omit<Issue, "id" | "createdAt">>): Promise<Issue>;
export declare function updateIssueStatus(baseUrl: string, id: string, status: IssueStatus): Promise<Issue>;
