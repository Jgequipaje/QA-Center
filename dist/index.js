...
function ze({ children: e }) {
  ...
  return (
    ...
    t
      ? /* @__PURE__ */ r(fe.Provider, {
          value: { theme: n, toggle: () => i((d) => (d === "light" ? "dark" : "light")) },
          children: e,
        })
      : /* @__PURE__ */ r(fe.Provider, {
          value: { theme: n, toggle: () => {} },
...
const xe = (e) => {
    ...
    const i = /* @__PURE__ */ new Set(),
      t = (x, b) => {
        ...
        if (!Object.is(p, n)) {
          const C = n;
          ((n = (b ?? (typeof p != "object" || p === null)) ? p : Object.assign({}, n, p)),
            i.forEach((D) => D(n, C)));
        }
      },
      s = () => n,
      m = {
        ...
        getState: s,
        getInitialState: () => g,
        subscribe: (x) => (i.add(x), () => i.delete(x)),
      },
      g = (n = e(t, s, m));
    return m;
  },
...
async function De(e, n) {
  if (!(await fetch(`${e}/api/qa-issues/${n}`, { method: "DELETE" })).ok)
...
const ce = Fe((e, n) => ({
    ...
    addIssue: (i, t) => {
      (e((s) => ({ issues: [t, ...s.issues], isCreating: !1, selectedIssueId: t.id })),
        Me(i, t)
          .then((s) => {
            e((d) => ({
...
function Ue({ buttonX: e, buttonY: n, buttonSize: i, hasIssues: t, spriteUrl: s, baseUrl: d }) {
  const u = s ?? `${d}/oneko.gif`,
    [m, g] = h(`${-3 * ee}px ${-3 * ee}px`),
    x = U(0),
    b = U(0),
    p = U(0),
    C = U(0),
    ...
    H(() => {
      function L(v) {
        if ((C.current || (C.current = v), v - C.current > 150)) {
          C.current = v;
          const z = t ? je : qe,
            E = z[x.current % z.length],
            M = Pe[E],
            [$, P] = M[b.current % M.length];
          (g(`${$ * ee}px ${P * ee}px`),
            (b.current += 1),
            b.current >= M.length &&
              ((b.current = 0), (x.current += 1), x.current >= z.length && (x.current = 0)));
        }
...
function Ye() {
  const { theme: e } = oe(),
    n = ie[e],
    { isDrawerOpen: i, openDrawer: t, closeDrawer: s, issues: d, loadIssues: u } = ce(),
    {
      buttonColor: m,
      buttonSize: g,
      shape: x,
    ...
    k = d.filter(
      (f) => f.status === "open" || f.status === "in_progress" || f.status === "ready_for_qa"
    ).length,
    L = d.some(
      (f) =>
        (f.origin === "manual" || f.origin === "feature") &&
        (f.status === "open" || f.status === "in_progress" || f.status === "ready_for_qa")
    ),
    [v, z] = h(null),
    E = U(!1),
    M = U(!1),
  ...
  const N = be(
      (f) => {
        if (!E.current) return;
        const y = f.clientX - P.current.x,
          B = f.clientY - P.current.y;
  ...
  function O(f) {
    var y;
    (f.button !== 0 && f.pointerType === "mouse") ||
      (f.preventDefault(),
      (E.current = !0),
      (M.current = !1),
      ($.current = f.pointerId),
      (P.current = { x: f.clientX, y: f.clientY }),
      (W.current = v ?? Se(g)),
      (y = q.current) == null || y.setPointerCapture(f.pointerId),
...
function Ke({ issue: e, selected: n, onClick: i }) {
  const { theme: t } = oe(),
    s = ie[t],
    d = e.origin === "imported_markdown",
    u = we[e.origin] ?? we.manual,
    m =
      e.origin === "feature"
        ? "#a78bfa"
        : e.origin === "note"
          ...
          : d
            ? s.infoText
            : (Ve[e.severity ?? "info"] ?? s.textFaint),
    g = Je[e.status] ?? { bg: s.bgMuted, color: s.textMuted };
              ...
              children: [
                ...
                !d &&
                  ...
                  /* @__PURE__ */ r("span", {
                    ...
                    children: e.severity.charAt(0).toUpperCase() + e.severity.slice(1),
                  }),
                e.origin === "feature" &&
                  e.severity &&
                  /* @__PURE__ */ o("span", {
                    ...
                    children: ["P: ", e.severity.charAt(0).toUpperCase() + e.severity.slice(1)],
                  }),
                e.area &&
                  /* @__PURE__ */ r("span", {
                    style: {
                ...
                d &&
                  e.sourceRef &&
                  /* @__PURE__ */ r("span", {
                    style: { fontSize: 10, color: s.textFaint },
                    children: e.sourceRef,
                  }),
                e.automationStatus &&
                  e.origin === "manual" &&
                  /* @__PURE__ */ r("span", {
                    style: {
                      ...
                      background: s.bgMuted,
                      color:
                        e.automationStatus.result === "passed"
                          ? "#4ade80"
                          : e.automationStatus.result === "failed"
                            ? "#f87171"
                            : s.textFaint,
                      fontWeight: 600,
                    },
...
function lt({ issue: e, onClose: n }) {
  ...
  const { theme: i } = oe(),
    t = ie[i],
    { updateIssueStatus: s, updateIssue: d, saveIssue: u, deleteIssue: m, loadIssues: g } = ce(),
    { baseUrl: x } = de(),
    [b, p] = h(!1),
    [C, D] = h(null),
    [k, L] = h(!1),
  ...
  const a = e.origin,
    T = a === "note" ? tt : a === "feature" ? et : Ze,
    w = a === "note" ? ot : a === "feature" ? rt : nt,
    Y = T[e.status] ?? [],
    j = ((Z = e.automationStatus) == null ? void 0 : Z.result) ?? "not_run",
    ne = !!e.linkedTest && a === "manual";
  function K(c) {
    return c !== "verified" || a !== "manual" || !ne ? !0 : j === "passed";
  }
  function se(c) {
    return c !== "verified" || a !== "manual" || !ne
      ? null
      : j !== "passed"
        ...
        children: [
            ...
            children: [
              k
                ? /* @__PURE__ */ r("input", {
                    ...
                    style: { ...G, fontSize: 13, fontWeight: 700, flex: 1, marginRight: 8 },
              ...
              /* @__PURE__ */ r("button", {
                ...
                style: {
                  background: "none",
                  border: "none",
                  cursor: b || S ? "not-allowed" : "pointer",
                  color: b || S ? t.textFaint : t.textMuted,
                  fontSize: 16,
                  padding: 0,
                },
                title: b || S ? "Operation in progress..." : void 0,
                children: "✕",
              }),
            ],
          }),
          !k &&
            /* @__PURE__ */ o("div", {
              ...
              children: [
                a === "feature" &&
                  /* @__PURE__ */ r(le, { label: "✨ Feature", color: t.infoText, bg: t.infoBg }),
                a === "note" &&
                  /* @__PURE__ */ r(le, { label: "📝 Note", color: t.textMuted, bg: t.bgMuted }),
                /* @__PURE__ */ r(le, { label: Te(e.status), color: t.infoText, bg: t.infoBg }),
                e.severity &&
                  a !== "note" &&
                  /* @__PURE__ */ r(le, {
                    label: a === "feature" ? `Priority: ${e.severity}` : e.severity,
                    color: t.warnText,
                    bg: t.warnBg,
                  }),
                e.area &&
                  /* @__PURE__ */ r(le, { label: e.area, color: t.textMuted, bg: t.bgMuted }),
              ],
            }),
          k &&
            /* @__PURE__ */ o("div", {
              ...
              children: [
                    ...
                    children: [
                      /* @__PURE__ */ o("div", {
                        ...
                        children: [
                          /* @__PURE__ */ r("label", {
                            style: l,
                            children: a === "feature" ? "Priority" : "Severity",
                          }),
                          /* @__PURE__ */ r("select", {
                            value: P,
                            onChange: (c) => W(c.target.value),
                            style: G,
                            children: ["critical", "high", "medium", "low", "info"].map((c) =>
                              /* @__PURE__ */ r(
                                "option",
                                { value: c, children: c.charAt(0).toUpperCase() + c.slice(1) },
                                c
                              )
                            ),
                          }),
                ...
                /* @__PURE__ */ o("div", {
                  children: [
                    /* @__PURE__ */ r("label", {
                      style: l,
                      children: a === "note" ? "Content" : "Description",
                    }),
                    /* @__PURE__ */ r("textarea", {
                      value: M,
                      onChange: (c) => $(c.target.value),
                      rows: a === "note" ? 8 : 3,
                      style: { ...G, resize: "vertical" },
                      placeholder: a === "note" ? "Write your note..." : "What is the issue?",
                    }),
                  ],
                }),
                a === "manual" &&
          ...
          !k &&
            /* @__PURE__ */ o(J, {
              children: [
                  ...
                  /* @__PURE__ */ o("div", {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ r("div", {
                        ...
                        children: e.linkedTest.fullTitle,
                      }),
                      /* @__PURE__ */ o("div", {
                        style: { display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" },
                        children: [
                          /* @__PURE__ */ r("span", {
                            style: { fontSize: 11, fontWeight: 700, color: it[j] ?? t.textFaint },
                            children:
                              j === "not_run"
                                ? "Not run yet"
                                : j === "passed"
                          ...
                          ((V = e.automationStatus) == null ? void 0 : V.lastRun) &&
                            /* @__PURE__ */ o("span", {
                              style: { fontSize: 11, color: t.textFaint },
                              children: ["· ", pe(e.automationStatus.lastRun)],
                            }),
                        ],
                      }),
                      ((he = e.automationStatus) == null ? void 0 : he.message) &&
                        j === "failed" &&
                        /* @__PURE__ */ r("pre", {
                          style: {
                            fontSize: 11,
                          ...
                          children: e.automationStatus.message,
                        }),
                      C &&
                        /* @__PURE__ */ r("div", {
                      ...
                      b &&
                        /* @__PURE__ */ r("div", {
                          style: { fontSize: 11, color: t.infoText, marginTop: 4 },
                ...
                (e.expected || e.actual) &&
                  /* @__PURE__ */ o("div", {
                    ...
                    children: [
                      ...
                      e.expected &&
                        /* @__PURE__ */ o("div", {
                          style: { color: t.passText, fontSize: 12, marginBottom: 4 },
                          children: ["Expected: ", e.expected],
                        }),
                      e.actual &&
                        /* @__PURE__ */ o("div", {
                          style: { color: t.failText, fontSize: 12 },
                          children: ["Actual: ", e.actual],
                        }),
                    ],
                  }),
                e.notes &&
                  /* @__PURE__ */ o("div", {
                    ...
                    children: [
                      /* @__PURE__ */ r("div", {
                        ...
                        children: a === "feature" ? "Acceptance Criteria" : "Notes",
                      }),
                      /* @__PURE__ */ r("pre", {
                        style: {
                          margin: 0,
                ...
                /* @__PURE__ */ o("div", {
                  style: { fontSize: 11, color: t.textFaint, marginTop: 12 },
                  children: ["Created ", pe(e.createdAt), " · Updated ", pe(e.updatedAt)],
                }),
              ],
            }),
        ],
                  ...
                  return /* @__PURE__ */ r(
                    "button",
                    {
                      ...
                      style: {
                        ...
                        background: c === "verified" && !re ? t.btnActive : t.btnIdle,
                        color: c === "verified" && !re ? t.btnActiveTxt : t.btnIdleTxt,
                        border:
                          c === "closed" ? `1px solid ${t.failText}` : `1px solid ${t.border}`,
                        opacity: re ? 0.45 : 1,
                      },
                      children: w[c] ?? Te(c),
                    },
...
function at({ onClose: e, origin: n = "manual" }) {
  ...
  const ne = (O ? W.filter((l) => l.fullTitle.toLowerCase().includes(O.toLowerCase())) : W).reduce(
      (l, Z) => {
  ...
  const I = {
    ...
    ue = n === "feature" ? "✨ New Feature" : n === "note" ? "📝 New Note" : "🐛 New Issue",
    G = n === "feature" ? "Add Feature" : n === "note" ? "Add Note" : "Create Issue";
  return /* @__PURE__ */ o("div", {
    style: { display: "flex", flexDirection: "column", flex: 1, overflow: "hidden" },
    children: [
      /* @__PURE__ */ o("div", {
                  ...
                  children: [
                    /* @__PURE__ */ o("div", {
                      ...
                      children: [
                        /* @__PURE__ */ r("label", {
                          style: A,
                          children: "Link Playwright Test (optional)",
                        }),
                        /* @__PURE__ */ r("button", {
                          type: "button",
                          onClick: Y,
                          ...
                          /* @__PURE__ */ r(
                            "optgroup",
                            {
                              ...
                              children: Z.map((V) =>
                                /* @__PURE__ */ r(
                                  "option",
                                  { value: V.id, children: V.testTitle },
                                  V.id
                                )
                              ),
                            },
                    ...
                    K &&
                      /* @__PURE__ */ o("div", {
                        style: { fontSize: 11, color: t.infoText, marginTop: 6 },
                        children: ["✓ ", K.fullTitle],
                      }),
                  ],
                }),
                /* @__PURE__ */ o("div", {
                    ...
                    /* @__PURE__ */ o("div", {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ r("select", {
                          ...
                          style: I,
                          children: ["critical", "high", "medium", "low", "info"].map((l) =>
                            /* @__PURE__ */ r(
                              "option",
                              { value: l, children: l.charAt(0).toUpperCase() + l.slice(1) },
                              l
                            )
                          ),
                        }),
...
function st({ message: e, sub: n }) {
  const { theme: i } = oe(),
    t = ie[i];
  return /* @__PURE__ */ o("div", {
    style: { padding: "2rem 1rem", textAlign: "center", color: t.textFaint, fontSize: 13 },
    children: [
      /* @__PURE__ */ r("div", {
        style: { fontSize: 15, fontWeight: 600, color: t.textMuted, marginBottom: 4 },
        children: e,
      }),
...
function dt() {
  ...
  if (!g) return null;
  const P = /* @__PURE__ */ new Set(["open", "in_progress", "ready_for_qa"]),
    W = 10,
    q = p.page ?? 1,
    N = (a) => C({ page: a }),
    Q = p.origin ?? "manual",
    ...
    f = b.filter((a) => {
      ...
      if (p.search) {
        ...
        return (
          a.title.toLowerCase().includes(Y) ||
          (((T = a.area) == null ? void 0 : T.toLowerCase().includes(Y)) ?? !1) ||
          (((w = a.description) == null ? void 0 : w.toLowerCase().includes(Y)) ?? !1)
        );
      }
      if (Q === "manual") {
        if (a.origin !== "manual" && a.origin !== "imported_markdown") return !1;
      } else if (a.origin !== Q) return !1;
      return !(O !== "all" && a.status !== O);
    }),
    y = k ? (b.find((a) => a.id === k) ?? null) : null,
    B = b.filter((a) => P.has(a.status)).length,
    _ = Math.ceil(f.length / W),
    S = Math.min(q, Math.max(1, _)),
    te = f.slice((S - 1) * W, S * W);
  return /* @__PURE__ */ o(J, {
    children: [
      /* @__PURE__ */ r("div", {
        onClick: x,
          ...
          /* @__PURE__ */ o("div", {
            ...
            children: [
              /* @__PURE__ */ o("div", {
                children: [
                  /* @__PURE__ */ r("div", {
                    style: { fontWeight: 700, fontSize: 14, color: n.text },
                    children: i,
                  }),
                  /* @__PURE__ */ r("div", {
                    style: { fontSize: 11, color: n.textFaint, marginTop: 2 },
                    children: M
                      ? "Loading..."
                      : B > 0
                        ? `${B} active issue${B > 1 ? "s" : ""}`
                        : "No active issues",
                  }),
                ],
              }),
                        ...
                        children: [
                          /* @__PURE__ */ o("button", {
                            ...
                            style: {
                              ...
                              fontSize: 12,
                              fontWeight: 600,
                              background: n.btnActive,
                              color: n.btnActiveTxt,
                              border: "none",
                              borderRadius: 6,
                              cursor: "pointer",
                              fontFamily: "inherit",
                              ...
                              children: [
                                ...
                                /* @__PURE__ */ r(
                                  "button",
                                  {
                                    ...
                                    onMouseEnter: (w) =>
                                      (w.currentTarget.style.background = n.bgMuted),
                                    onMouseLeave: (w) =>
                                      (w.currentTarget.style.background = "none"),
                                    children: T,
                                  },
                                  a
                                )
                    ...
                    return /* @__PURE__ */ r(
                      "button",
                      {
                        ...
                        style: {
                          padding: "5px 12px",
                          fontSize: 12,
                          fontWeight: w ? 700 : 500,
                          background: w ? n.bg : "transparent",
                          color: w ? n.text : n.textMuted,
                          border: w ? `1px solid ${n.border}` : "1px solid transparent",
                          borderBottom: w ? `1px solid ${n.bg}` : "1px solid transparent",
                        ...
                        return /* @__PURE__ */ r(
                          "button",
                          {
                            ...
                            style: {
                              padding: "3px 10px",
                              fontSize: 11,
                              fontWeight: j ? 700 : 500,
                              borderRadius: 99,
                              border: `1px solid ${j ? n.accent : n.border}`,
                              background: j ? n.accent : "transparent",
                              color: j ? n.accentText : n.textMuted,
                              cursor: "pointer",
                              fontFamily: "inherit",
                              whiteSpace: "nowrap",
                            },
              ...
              !v &&
                ...
                (f.length === 0
                  ? /* @__PURE__ */ r(st, {
                      ...
                      sub: (() => {
                        if (p.search)
                          return `No items match "${p.search}". Try a different search term.`;
                        if (
                          !b.some((w) =>
                            R === "manual"
                              ? w.origin === "manual" || w.origin === "imported_markdown"
                              : w.origin === R
                          )
                        )
                          return R === "feature"
                                ...
                                : F === "ready_for_qa"
                                  ...
                                  : F === "verified"
                                    ...
                                    : F === "closed"
                                      ...
                                      : F;
                        return R === "feature"
                          ? `No ${T ? T + " " : ""}features. Try a different filter.`
                          : R === "note"
                            ? `No ${T ? T + " " : ""}notes. Try a different filter.`
                            : `No ${T ? T + " " : ""}issues. Try a different filter.`;
                      })(),
                    })
                  : /* @__PURE__ */ o("div", {
                      style: {
                      ...
                      children: [
                        /* @__PURE__ */ r("div", {
                          ...
                          children: te.map((a, T) =>
                            /* @__PURE__ */ r(
                              Ke,
                              { issue: a, selected: k === a.id, onClick: () => L(a.id) },
                              `${a.id}-${T}`
                            )
                          ),
                        }),
                            ...
                            children: [
                              /* @__PURE__ */ r("button", {
                                ...
                                style: {
                                  ...
                                  borderRadius: 6,
                                  border: `1px solid ${n.border}`,
                                  background: n.btnIdle,
                                  color: S === 1 ? n.textFaint : n.btnIdleTxt,
                              ...
                              /* @__PURE__ */ o("span", {
                                style: { fontSize: 12, color: n.textMuted },
                                children: [
                                  S,
                                  " / ",
                                  _,
                              ...
                              /* @__PURE__ */ r("button", {
                                ...
                                style: {
                                  ...
                                  border: `1px solid ${n.border}`,
                                  background: n.btnIdle,
                                  color: S === _ ? n.textFaint : n.btnIdleTxt,
                                  cursor: S === _ ? "not-allowed" : "pointer",
                                  fontFamily: "inherit",
                                },
                                children: "Next →",
                              }),
...
function gt({
  ...
  if (
    ...
    return null;
  const k = /* @__PURE__ */ o(Ce.Provider, {
    value: {
      baseUrl: b,
      buttonColor: p,
      buttonSize: n,
    ...
    children: [/* @__PURE__ */ r(Ye, {}), /* @__PURE__ */ r(dt, {})],
  });
  return m ? /* @__PURE__ */ r(ze, { children: k }) : k;
}
export { gt as QACenter };
