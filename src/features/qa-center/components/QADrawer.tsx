  ...
  return (
    <>
      ...
      >
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: t.textFaint, marginTop: 2 }}>
              {isLoading
                ? "Loading..."
                : openCount > 0
                  ? `${openCount} active issue${openCount > 1 ? "s" : ""}`
                  : "No active issues"}
            </div>
          </div>
        ...
        {!isCreating && !selectedIssue && (
          <div
            style={{ borderBottom: `1px solid ${t.border}`, background: t.bgSubtle, flexShrink: 0 }}
          >
                  ...
                  return statusOptions.map(({ v, l }) => {
                    ...
                    return (
                      <button
                        key={v}
                        onClick={() => {
                          setFilters({ status: v as never, page: 1 });
                        }}
                ...
                sub={(() => {
                  ...
                  if (!hasAny) {
                    ...
                    if (activeOrigin === "note")
                      return "Click '+ Add' → Note to capture your first note.";
                  ...
                  if (activeOrigin === "note")
                    return `No ${statusLabel ? statusLabel + " " : ""}notes. Try a different filter.`;
                  ...
                  >
                    <button
                      ...
                      style={{
                        ...
                        color: safePage === 1 ? t.textFaint : t.btnIdleTxt,
                    ...
                    <span style={{ fontSize: 12, color: t.textMuted }}>
                      {safePage} / {totalPages}{" "}
                      <span style={{ color: t.textFaint }}>({visible.length} total)</span>
                    </span>
                    <button
                      ...
                      style={{
                        ...
                        border: `1px solid ${t.border}`,
                        background: t.btnIdle,
                        color: safePage === totalPages ? t.textFaint : t.btnIdleTxt,
